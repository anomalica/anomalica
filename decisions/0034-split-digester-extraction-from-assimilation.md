...
Two things both halves must agree on were at risk of drifting if duplicated: the digest interchange format (0027), and the shared Claude transport.
...
- The shared Claude transport is single-sourced in anomalica-common, so both repositories use it identically.
