...
1. The AI will analyse the difference between the old and new versions and categorise the changes.
...
Two edit interfaces will be available: users will be able to write directives directly, or edit the article text and let the AI extract directives from the differences.
